...
#Se define una distancia asociada a la formación de la imágen --> #UNIDADES: m
distancia_Imagen = distancia_focalMO + distancia_TL


#Distancia focal asociada a la lente d
